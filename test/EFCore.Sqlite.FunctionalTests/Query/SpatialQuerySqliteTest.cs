...
SELECT ""e"".""Id"", CASE
    ...
    THEN 0 ELSE CoveredBy(""e"".""Point"", @__polygon_0)
END AS ""CoveredBy""
FROM ""PointEntity"" AS ""e""");
        }
...
SELECT ""e"".""Id"", CASE
    ...
    THEN 0 ELSE Covers(""e"".""Polygon"", @__point_0)
END AS ""Covers""
FROM ""PolygonEntity"" AS ""e""");
        }
...
SELECT ""e"".""Id"", CASE
    ...
    THEN 0 ELSE Crosses(""e"".""LineString"", @__lineString_0)
END AS ""Crosses""
FROM ""LineStringEntity"" AS ""e""");
        }
...
SELECT ""e"".""Id"", CASE
    WHEN ""e"".""Polygon"" IS NULL
    THEN 0 ELSE Disjoint(""e"".""Polygon"", @__point_0)
END AS ""Disjoint""
FROM ""PolygonEntity"" AS ""e""");
        }
...
SELECT ""e"".""Id"", CASE
    WHEN ""e"".""Point"" IS NULL
    THEN 0 ELSE Equals(""e"".""Point"", @__point_0)
...
SELECT ""e"".""Id"", CASE
    WHEN ""e"".""LineString"" IS NULL
    THEN 0 ELSE Intersects(""e"".""LineString"", @__lineString_0)
END AS ""Intersects""
FROM ""LineStringEntity"" AS ""e""");
        }
        ...
        public override async Task ICurve_IsClosed(bool isAsync)
        {
            ...
            AssertSql(
                @"SELECT ""e"".""Id"", CASE
    WHEN ""e"".""LineString"" IS NULL
    THEN 0 ELSE IsClosed(""e"".""LineString"")
END AS ""IsClosed""
FROM ""LineStringEntity"" AS ""e""");
        }
    ...
    THEN 0 ELSE IsClosed(""e"".""MultiLineString"")
END AS ""IsClosed""
FROM ""MultiLineStringEntity"" AS ""e""");
        }
        ...
        public override async Task IsEmpty(bool isAsync)
        {
            ...
            AssertSql(
                @"SELECT ""e"".""Id"", CASE
    WHEN ""e"".""MultiLineString"" IS NULL
    THEN 0 ELSE IsEmpty(""e"".""MultiLineString"")
END AS ""IsEmpty""
FROM ""MultiLineStringEntity"" AS ""e""");
        }
        ...
        public override async Task IsRing(bool isAsync)
        {
            ...
            AssertSql(
                @"SELECT ""e"".""Id"", CASE
    WHEN ""e"".""LineString"" IS NULL
    THEN 0 ELSE IsRing(""e"".""LineString"")
END AS ""IsRing""
FROM ""LineStringEntity"" AS ""e""");
        }
        ...
        public override async Task IsSimple(bool isAsync)
        {
            ...
            AssertSql(
                @"SELECT ""e"".""Id"", CASE
    WHEN ""e"".""LineString"" IS NULL
    THEN 0 ELSE IsSimple(""e"".""LineString"")
END AS ""IsSimple""
FROM ""LineStringEntity"" AS ""e""");
        }
...
SELECT ""e"".""Id"", CASE
    WHEN ""e"".""Polygon"" IS NULL
    THEN 0 ELSE Overlaps(""e"".""Polygon"", @__polygon_0)
END AS ""Overlaps""
FROM ""PolygonEntity"" AS ""e""");
        }
...
SELECT ""e"".""Id"", CASE
    WHEN ""e"".""Polygon"" IS NULL
    THEN 0 ELSE Relate(""e"".""Polygon"", @__polygon_0, '212111212')
END AS ""Relate""
FROM ""PolygonEntity"" AS ""e""");
        }
...
SELECT ""e"".""Id"", CASE
    WHEN ""e"".""Polygon"" IS NULL
    THEN 0 ELSE Touches(""e"".""Polygon"", @__polygon_0)
END AS ""Touches""
FROM ""PolygonEntity"" AS ""e""");
        }
...
SELECT ""e"".""Id"", CASE
    WHEN ""e"".""Point"" IS NULL
    THEN 0 ELSE Within(""e"".""Point"", @__polygon_0)
END AS ""Within""
FROM ""PointEntity"" AS ""e""");
        }
